...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"> @section('content') <div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6"> @foreach($getUserinfo as $Users) <h1>Hi {{$Users->user_name}}!</h1>
                </div>
                <div class="col-sm-6">
        ...
        <!-- /.container-fluid -->
    </section> @if(Session::has('user_updated')) <div class="alert alert-success" class="profile" role="alert">
    ...
    <div class="card card-primary card-outline">
        <div class="card-body box-profile">
            ...
            <!-- Main content -->
            <form method="post" action="/customer/custProf/{{$Users->user_id}}"> @csrf <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <td>
                        ...
                        <td>
                            <div class="form-group" style="width: 300px">
                                ...
                                <select readonly id="userType_id" class="form-control custom-select" name="userType_id"> @if($Users->userType_id=="1") <option value="1" selected>Admin</option>
                                    <option value="2">Veterinary</option>
                                    <option value="3">Customer</option> @elseif ($Users->userType_id=="2") <option value="1">Admin</option>
                                    <option value="2" selected>Veterinary</option>
                                    <option value="3">Customer</option> @elseif ($Users->userType_id=="3") <option value="1">Admin</option>
                                    <option value="2">Veterinary</option>
                                    <option value="3" selected>Customer</option> @endif
                                </select>
                            </div>
                        </td>
                        <div style="text-align: right; height: 100; padding-top: 20px">
                            <button type="submit" class="btn btn-primary btn-sm" style=" height: 50%;">
                                <i class="fas fa-user"></i> Update User </a>
                            </button>
                    </thead> @endforeach
                </table>
        </div>
