                    ...
                    <div class="card card-primary card-outline ">
                        <div class="card-body  box-profile card text-center">
                            <div class="card text-center">
                                ...
                                <a href="custAcc" id="change_dp" class="btn btn-primary btn-block">
                                    <b>Change Picture</b>
                                </a>
                            </div>
                            <!-- /.row -->
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class=" active tab-pane" id="personal_info">
                                    <form class="form-horizontal" action="/veterinary/editprofile/{{ $LoggedUserInfo->customer_id }}/{{ $LoggedUserInfo->user_id }}" method="POST" action="#" id="InfoForm"> @csrf <table class="table">
                                            <thead>
                                                <tr>
                                                    <td style="border: none">
                                                        <div class="form-group row" style="width: 250px">
                                                            <label for="inputName">Username:</label>
                                                            <input type="text" class="form-control" id="user_name" value="{{ $LoggedUserInfo->user_name }}" placeholder="Enter User Name" name="name">
                                        ...
                                        <div class="form-group row" style="width: 250px">
                                            <div class="sm-2 col-sm-12">
                                                <button type="submit" class="btn btn-danger text-ali">Save Changes</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
