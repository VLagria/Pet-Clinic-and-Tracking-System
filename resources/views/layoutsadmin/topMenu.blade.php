             ...
             <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                 <a href="#" class="dropdown-item">
                     ...
                     <div class="media">
                         ...
                         <div class="media-body">
                             <h3 class="dropdown-item-title"> Rouen Mayormita <span class="float-right text-sm text-danger">
                 ...
                 <a href="#" class="dropdown-item">
                     ...
                     <div class="media">
                         ...
                         <div class="media-body">
                             <h3 class="dropdown-item-title"> Rosh Asares <span class="float-right text-sm text-muted">
                                     <i class="fas fa-star"></i>
                                 </span>
                             </h3>
                             <p class="text-sm">Good day , I would like to request a new password</p>
                             <p class="text-sm text-muted">
                                 <i class="far fa-clock mr-1"></i> 1 minute ago
                             </p>
                         </div>
                     </div>
                     <!-- Message End -->
                 ...
                 <a href="#" class="dropdown-item">
                     ...
                     <div class="media">
                         ...
                         <div class="media-body">
                             <h3 class="dropdown-item-title"> Kathleen Dabalos <span class="float-right text-sm text-warning">
                                     <i class="fas fa-star"></i>
                                 </span>
                             </h3>
